    ...
    <div className="w-full font-sans text-xs">
        ...
        <tbody>
          <tr>
            ...
            <td className={`${cell} text-center align-middle p-3`}>
              <p className="text-2xl font-black tracking-widest text-red-700 mb-3">
                COTIZACION
              </p>
              <table className="mx-auto border-collapse">
                <tbody>
                  <tr>
                    <td className="border border-black px-3 py-1 text-gray-500 font-semibold">
                      Fecha
                    </td>
                    <td className="border border-black px-3 py-1 font-bold">
                      {formatDateMX(data.date)}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-black px-3 py-1 text-gray-500 font-semibold">
        ...
        <tbody>
          <tr>
            <td className={`${cell} w-[40%] py-1.5`}>
              <p className="text-[9px] font-bold text-gray-400 tracking-wider mb-0.5">
                CLIENTE
              </p>
      ...
      <table className="w-full border-collapse table-fixed">
        ...
        <thead>
          <tr className="bg-red-700 text-white">
            <th className="border border-red-700 p-1.5 text-center font-bold">
              CANT.
            </th>
            <th className="border border-red-700 p-1.5 text-left font-bold">
              DESCRIPCIÓN
            </th>
            <th className="border border-red-700 p-1.5 text-right font-bold">
              P. UNITARIO
            </th>
            <th className="border border-red-700 p-1.5 text-right font-bold">
              TOTAL
      ...
      <table className="w-full border-collapse">
        <tbody>
          ...
          <tr>
            <td className={`${cellR} bg-red-200 font-bold text-sm`}>
              TOTAL NETO
            </td>
            <td className={`${cellR} bg-red-200 font-bold text-sm`}>
              {mxn(totals.total)}
      ...
      <table className="w-full border-collapse">
        <tbody>
          <tr>
            <td
              className={`${cell} text-center italic font-bold text-red-700 text-sm p-3`}
            >
